...
// WithDefaults hydrates default values in the get stat params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetStatParams) WithDefaults() *GetStatParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get stat params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetStatParams) SetDefaults() {
